    ...
    messages: [
      {
        ...
        content: [
          ...
          {
            type: "text",
            text: "Analyze this reference ad image and generate the Nano Banana prompt and copy variations adapted for the Bugo Fly mosquito/fly repeller. Return the response as JSON.",
          },
        ],
      },
    ],
